...
dftg = dftg.drop(['series', 'previousPrice', 'netPrice', 'tradedQuantity', 'turnoverInLakhs', 'lastCorpAnnouncementDate', 'lastCorpAnnouncement'], axis=1)

top_losers = nse.get_top_losers()
dftl = pd.DataFrame(top_losers)
dftl = dftl.drop(['series', 'previousPrice', 'netPrice', 'tradedQuantity', 'turnoverInLakhs', 'lastCorpAnnouncementDate', 'lastCorpAnnouncement'], axis=1)
...
st.sidebar.markdown('''
---
Created with ❤️ by [Jesal Shah](https://www.youtube.com/@jesaltechsolution).
''')
